                ...
                <div className="edit-listing-form-grid">
                  ...
                  <div className="edit-listing-form-group">
                    ...
                    >
                      ...
                      <option value="50000">20,000 - 50,000 sq ft</option>
                      <option value="100000">50,000+ sq ft</option>
                    </select>
                  </div>
                  <div className="edit-listing-form-group">
                  ...
                  <div className="edit-listing-form-group">
                    ...
                    >
                      ...
                      <option value="2024">2024 (New)</option>
                      ...
                      <option value="1985">1985 - 1989</option>
                      <option value="1980">1980 - 1984</option>
                      <option value="1975">Before 1980</option>
                    </select>
                  </div>
                  <div className="edit-listing-form-group">
                    ...
                    >
                      ...
                      <optgroup label="Commercial Zones">
                        <option value="B1">B1 - Business 1</option>
                        <option value="B2">B2 - Business 2</option>
                        <option value="C1">C1 - Commercial 1</option>
                        <option value="C2">C2 - Commercial 2</option>
                      </optgroup>
                      <optgroup label="Industrial Zones">
                        <option value="BP">BP - Business Park</option>
                        <option value="BP1">BP1 - Business Park-White</option>
                        <option value="BP2">BP2 - Business Park-Black</option>
                        <option value="B1A">B1A - Business 1-Amenity</option>
                        <option value="B2A">B2A - Business 2-Amenity</option>
                      </optgroup>
                      <optgroup label="Warehouse/Storage">
                        <option value="WH">WH - Warehouse</option>
                        <option value="W1">W1 - Warehouse 1</option>
                        <option value="W2">W2 - Warehouse 2</option>
                      </optgroup>
                      <optgroup label="Other">
                        <option value="MU">MU - Mixed Use</option>
                        <option value="SP">SP - Special Purpose</option>
                      </optgroup>
                    </select>
                  </div>
                  <div className="edit-listing-form-group">
                    ...
                    >
                      ...
                      <option value="10">5-10 Spaces</option>
                      <option value="20">10-20 Spaces</option>
                      <option value="50">20-50 Spaces</option>
                      <option value="100">50-100 Spaces</option>
                      <option value="200">100+ Spaces</option>
                    </select>
                  </div>
                </div>
              </div>
