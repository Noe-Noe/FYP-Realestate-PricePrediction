...
const EditDisclaimer = () => {
  ...
  const [disclaimerText, setDisclaimerText] = useState(
    `This platform is provided "as is" without any warranties, express or implied. We make no representations about the accuracy, completeness, or reliability of any information, products, services, or related graphics contained on this platform for any purpose.
...
By using this platform, you agree to these terms and acknowledge that you use the platform at your own risk.`
  ...
  const handleSaveChanges = () => {
    console.log('Saving disclaimer changes:', disclaimerText);
    // Add save logic here
