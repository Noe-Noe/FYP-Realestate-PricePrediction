...
-- User profiles for personalization and trial system
CREATE TABLE user_profiles (
    id SERIAL PRIMARY KEY,
    user_id INTEGER NOT NULL,
    search_history JSONB DEFAULT '[]'::jsonb,
    click_tracking JSONB DEFAULT '{}'::jsonb,
    view_duration JSONB DEFAULT '{}'::jsonb,
...
CREATE TABLE user_reviews (
    ...
    review_category VARCHAR(20) CHECK (review_category IN ('general', 'feature', 'bug', 'experience', 'performance', 'support', 'pricing', 'property')) DEFAULT 'general',
